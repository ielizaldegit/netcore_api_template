...
namespace Infrastructure.Persistence.Configuration
{
    ...
    #region Adresses Configuration
    public class CountryConfiguration : IEntityTypeConfiguration<Country>
    {
        public void Configure(EntityTypeBuilder<Country> builder)
        {
            builder.ToTable("country", "address").HasKey(s => s.Id);
            builder.Property(p => p.Id).IsRequired().HasColumnName("country_id").HasColumnType("int").HasColumnOrder(1).UseIdentityColumn();
            builder.Property(p => p.Name).IsRequired().HasMaxLength(200).HasColumnName("name").HasColumnType("nvarchar").HasColumnOrder(2);
            builder.Property(p => p.Description).HasMaxLength(200).HasColumnName("description").HasColumnType("nvarchar").HasColumnOrder(3);
            builder.Property(p => p.Code).HasMaxLength(200).HasColumnName("code").HasColumnType("nvarchar").HasColumnOrder(4);
            builder.Property(p => p.IsActive).HasColumnName("is_active").HasColumnType("bit").HasColumnOrder(5);

            builder.HasMany(a => a.States).WithOne(b => b.Country);

            builder.HasData(DbSeed.SeedCountries());
        }
    }
    ...
    public class StateConfiguration : IEntityTypeConfiguration<State>
    {
        ...
        {
            builder.ToTable("state", "address").HasKey(s => s.Id);
            builder.Property(p => p.Id).IsRequired().HasColumnName("state_id").HasColumnType("int").HasColumnOrder(1).UseIdentityColumn();
            builder.Property(p => p.CountryId).HasColumnName("country_id").HasColumnType("int").HasColumnOrder(2);
            builder.Property(p => p.Name).IsRequired().HasMaxLength(200).HasColumnName("name").HasColumnType("nvarchar").HasColumnOrder(3);
            builder.Property(p => p.Description).HasMaxLength(200).HasColumnName("description").HasColumnType("nvarchar").HasColumnOrder(4);
            builder.Property(p => p.Code).HasMaxLength(200).HasColumnName("code").HasColumnType("nvarchar").HasColumnOrder(5);
            builder.Property(p => p.IsActive).HasColumnName("is_active").HasColumnType("bit").HasColumnOrder(6);

            builder.HasMany(a => a.Municipalities).WithOne(b => b.State);

            builder.HasData(DbSeed.SeedStates());
        }
    }
    ...
    public class MunicipalityConfiguration : IEntityTypeConfiguration<Municipality>
    {
        ...
        {
            builder.ToTable("municipality", "address").HasKey(s => new { s.Id, s.StateId });
            builder.Property(p => p.Id).IsRequired().HasColumnName("municipality_id").HasColumnType("int").HasColumnOrder(1);
            builder.Property(p => p.StateId).HasColumnName("state_id").HasColumnType("int").HasColumnOrder(2);
            builder.Property(p => p.Name).IsRequired().HasMaxLength(200).HasColumnName("name").HasColumnType("nvarchar").HasColumnOrder(3);
            builder.Property(p => p.Description).HasMaxLength(200).HasColumnName("description").HasColumnType("nvarchar").HasColumnOrder(4);
            builder.Property(p => p.Code).HasMaxLength(200).HasColumnName("code").HasColumnType("nvarchar").HasColumnOrder(5);
            builder.Property(p => p.IsActive).HasColumnName("is_active").HasColumnType("bit").HasColumnOrder(6);

            builder.HasData(DbSeed.SeedMunicipality());
        }
    }
    ...
    public class PostalCodeConfiguration : IEntityTypeConfiguration<PostalCode>
    {
        ...
        {
            builder.ToTable("postal_code", "address").HasKey(s => s.Id);
            builder.Property(p => p.Id).IsRequired().HasColumnName("postal_code_id").HasColumnType("int").HasColumnOrder(1);
            builder.Property(p => p.Code).IsRequired().HasMaxLength(10).HasColumnName("code").HasColumnType("nvarchar").HasColumnOrder(2);
            builder.Property(p => p.SettlementType).HasMaxLength(200).HasColumnName("settlement_type").HasColumnType("nvarchar").HasColumnOrder(3);
            builder.Property(p => p.Settlement).HasMaxLength(200).HasColumnName("settlement").HasColumnType("nvarchar").HasColumnOrder(4);
            builder.Property(p => p.StateId).HasColumnName("state_id").HasColumnType("int").HasColumnOrder(5);
            builder.Property(p => p.State).HasMaxLength(200).HasColumnName("state").HasColumnType("nvarchar").HasColumnOrder(6);
            builder.Property(p => p.MunicipalityId).HasColumnName("municipality_id").HasColumnType("int").HasColumnOrder(7);
            builder.Property(p => p.Municipality).HasMaxLength(200).HasColumnName("municipality").HasColumnType("nvarchar").HasColumnOrder(8);
            builder.Property(p => p.City).HasMaxLength(200).HasColumnName("city").HasColumnType("nvarchar").HasColumnOrder(9);
